package com.neohoods.space.platform.api.publicapi.auth;
...
import com.neohoods.space.platform.model.ConfirmResetPasswordRequest;
import com.neohoods.space.platform.model.LoginRequest;
import com.neohoods.space.platform.model.ResetPasswordRequest;
import com.neohoods.space.platform.model.SignUpRequest;
import com.neohoods.space.platform.model.User;
import com.neohoods.space.platform.model.VerifyEmail200Response;
import com.neohoods.space.platform.repositories.UsersRepository;
import com.neohoods.space.platform.services.JwtService;
import com.neohoods.space.platform.services.MailService;
                ...
                return request.map(req -> {
                        ...
                        if (user != null) {
                                try {
                                        ...
                                        mailService.sendTemplatedEmail(
                                                user,
                                                "Reset Your Password - Space NeoHoods",
