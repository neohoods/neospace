...
import com.neohoods.space.platform.exceptions.CodedException;
import com.neohoods.space.platform.exceptions.CodedError;
import com.neohoods.space.platform.exceptions.CodedErrorException;
...
public class MailService {
    ...
    @Value("${neohoods.space.email.template.logo-url}")
    private String logoUrl;

    @Value("${neohoods.space.email.template.app-name}")
